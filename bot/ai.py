        ...
        response = self.client.post(
            ...
            json={
                ...
                "instructions": (
                    ...
                    "При отсутствии истории BUY допустим только для исключительно "
                    "сильного нового сценария: оценка не ниже 85, объём не менее "
                    "x2, покупки от 60%, стакан от +15%, продолжающееся ускорение, "
                    "поддержка BTC и ширины рынка, без заметного отката. "
